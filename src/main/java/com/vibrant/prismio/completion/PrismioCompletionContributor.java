...
public class PrismioCompletionContributor extends CompletionContributor {
        ...
        private static final Set<String> DECLARATION_KEYWORDS = Set.of(
                        "let", "mut", "fn", "struct", "enum", "trait", "impl", "extern", "import");
        ...
        private CompletionContext analyzeContext(PsiElement position) {
                ...
                if (prevType == PrismioTypes.IDENTIFIER) {
                        ...
                        if (beforeIdentifier != null) {
                                ...
                                IElementType beforeType = beforeIdentifier.getNode() != null
                                                ? beforeIdentifier.getNode().getElementType()
                                                : null;
                ...
                result.addElement(LookupElementBuilder.create("fn main()")
                                ...
                                .withInsertHandler((insertContext, item) -> {
                                        ...
                                        insertContext.getDocument().insertString(
                                                        insertContext.getTailOffset(), template);
        ...
        private static class ParenthesisWithBraceInsertHandler implements InsertHandler<LookupElement> {
                ...
                public void handleInsert(@NotNull InsertionContext context, @NotNull LookupElement item) {
                        ...
                        int parenOffset = tailOffset - innerIndent.length() - indent.length() - 5; // Go back to find ()
        ...
        private static class BraceInsertHandler implements InsertHandler<LookupElement> {
                ...
                public void handleInsert(@NotNull InsertionContext context, @NotNull LookupElement item) {
                        ...
                        context.getEditor().getCaretModel().moveToOffset(context.getTailOffset() - indent.length() - 2);
                }
        }
}