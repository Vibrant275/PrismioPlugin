...
public interface PrismioTokenSets {
  ...
  TokenSet KEYWORDS = TokenSet.create(
          PrismioTypes.KEYWORD,
          PrismioTypes.TYPE_KEYWORD
  );
  ...
  TokenSet OPERATORS = TokenSet.create(
          PrismioTypes.ARITHMETIC_OP,
          PrismioTypes.RELATIONAL_OP,
          PrismioTypes.ASSIGNMENT_OP,
          PrismioTypes.UNARY_OP,
          PrismioTypes.LOGICAL_OP,
          PrismioTypes.COMPARISON,
          PrismioTypes.BITWISE,
          PrismioTypes.ARROW,
          PrismioTypes.FAT_ARROW
  );
  ...
  TokenSet SEPARATORS = TokenSet.create(
          ...
          PrismioTypes.LBRACE,
          PrismioTypes.RBRACE,
          PrismioTypes.LBRACKET,
          PrismioTypes.RBRACKET,
          PrismioTypes.COMMA,
          PrismioTypes.COLON,
          PrismioTypes.SEMICOLON,
          PrismioTypes.DOT
  );
}